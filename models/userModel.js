...
UserSchema.methods.fullName2 = function() {
...
UserSchema.methods.theDateToday= function() {



  var todaysDate = this.lastUpdated
  return todaysDate;
...
*/
UserSchema.methods.customThing = function() {
  var longername = this.username + this.lastname + this.firstname;
  return longername;
};
